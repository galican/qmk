...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_F] = LAYOUT_87_ansi( /* FN */
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, _______, SLED_HUI, _______, SLED_MOD,
    ...
    [MAC_F] = LAYOUT_87_ansi( /* FN */
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, SLED_HUI, _______, SLED_MOD,
