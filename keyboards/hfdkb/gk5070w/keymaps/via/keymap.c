...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_F] = LAYOUT_87_ansi( /* FN */
        ...
        _______, BT_1,    BT_2,    BT_3,    WL_2_4,  _______, SW_OS2,  SW_OS3,  _______, _______, _______, _______, _______, _______, _______, RM_HUEU, _______,
        RM_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RM_NEXT, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, LCD_LEFT,LCD_RIGHT,_______,         _______,          RM_VALU,
        _______, GU_TOGG, _______,                            _______,                            MO(2),   _______, _______, _______, RM_SPDD, RM_VALD, RM_SPDU),

    [WIN_F2] = LAYOUT_87_ansi( /* FN */
        KC_ESC,           KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_PSCR,  KC_SCRL, KC_PAUS,
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_INS,   SLED_HUI, KC_PGUP,
        SLED_TOG,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, SLED_MOD, KC_DEL,   KC_END,  KC_PGDN,
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_MUTE,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,           SLED_VAI,
        KC_LCTL, KC_LWIN, KC_LALT,                            KC_SPC,                             KC_RALT, MO(1),   KC_APP,  KC_RCTL, SLED_SPD,  SLED_VAD, SLED_SPI),
    ...
    [MAC_B] = LAYOUT_87_ansi( /* Base */
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_MUTE,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,           KC_UP,
        KC_LCTL, KC_LWIN, KC_LALT,                            KC_SPC,                             KC_RALT, MO(4),   KC_APP,  KC_RCTL, KC_LEFT,  KC_DOWN, KC_RGHT),
    ...
    [MAC_F] = LAYOUT_87_ansi( /* FN */
        ...
        _______, BT_1,    BT_2,    BT_3,    WL_2_4,  SW_OS1, _______,  SW_OS3,  _______, _______, _______, _______, _______, _______, _______, RM_HUEU, _______,
        RM_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RM_NEXT, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, LCD_LEFT,LCD_RIGHT,_______,         _______,          RM_VALU,
    ...
    [MAC_F2] = LAYOUT_87_ansi( /* FN */
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_MUTE,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,           SLED_VAI,
        KC_LCTL, KC_LWIN, KC_LALT,                            KC_SPC,                             KC_RALT, MO(4),   KC_APP,  KC_RCTL, SLED_SPD,  SLED_VAD, SLED_SPI),
    ...
    [LINUX_F] = LAYOUT_87_ansi( /* FN */
        EE_CLR,           KC_BRID, KC_BRIU, KC_CALC, KC_MYCM, KC_TASK, KC_PRJT, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______,
        _______, BT_1,    BT_2,    BT_3,    WL_2_4,  SW_OS1,  SW_OS2,  _______, _______, _______, _______, _______, _______, _______, _______, RM_HUEU, _______,
        RM_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RM_NEXT, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, LCD_LEFT,LCD_RIGHT,_______,         _______,          RM_VALU,
    ...
    [LINUX_F2] = LAYOUT_87_ansi( /* FN */
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_MUTE,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,           SLED_VAI,
        KC_LCTL, KC_LWIN, KC_LALT,                            KC_SPC,                             KC_RALT, MO(7),   KC_APP,  KC_RCTL, SLED_SPD,  SLED_VAD, SLED_SPI),
