...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_ansi_67( /* FN */
        EE_CLR,  KC_BRID,  KC_BRIU,  KC_WSCH,  KC_TASK, RM_VALU, RM_VALU, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD,    KC_VOLU, _______, _______,
        RM_HUEU, _______,  _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______,
    ...
    [MAC_FN] = LAYOUT_ansi_67( /* FN */
        EE_CLR,  KC_BRID,  KC_BRIU,  KC_MCTL,  KC_LPAD, RM_VALU, RM_VALU, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD,    KC_VOLU, _______, _______,
        RM_HUEU, _______,  _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______,
        _______, _______,  _______,  _______,  _______, _______, _______, _______, _______, _______, _______, _______,             _______, _______,
        _______,           _______,  _______,  _______, _______, _______,  _______, _______, _______, _______, _______,    _______, RM_VALU, _______,
        _______, _______,  _______,                              _______,                             _______, _______,    RM_SPDD, RM_VALD, RM_SPDU),
