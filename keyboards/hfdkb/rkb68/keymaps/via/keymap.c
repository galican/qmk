...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT( /* FN */
        ...
        KC_USB,  RM_TOGG,  RM_NEXT,  RM_PREV,  RM_HUEU, RM_HUED, RM_SATU, RM_SATD, RM_VALU, RM_VALD, RM_SPDU, RM_SPDD,    _______, _______, _______,
        _______, _______,  SW_OS1,   _______,  _______, _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______,
        _______, _______,  KC_MSEL,  KC_VOLD,  KC_VOLU, KC_MUTE, BT_VOL,  _______, _______, _______, _______, _______,    _______, _______, _______,
