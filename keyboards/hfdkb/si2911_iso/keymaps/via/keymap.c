...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_100_ansi(
        ...
        _______, _______,  _______,  _______,  _______,  _______, _______, _______, _______, _______, _______, _______,  _______,  RM_HUEU,  _______,  _______, _______,  _______,
        BLED_MOD,_______,  BLED_HUI, _______,  _______,  _______, BT_VOL,  _______, _______, _______, _______, SLED_HUI, SLED_MOD, RM_VALU,            _______, _______,  _______,  _______,
