...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT( /* FN */
        BT_2_4G, BT_HOST1, BT_HOST2, BT_HOST3, _______, _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______,
        ...
        case KEY_FUN: {
            if (record->event.pressed) {
                if (get_highest_layer(default_layer_state) == WIN_B) {
                    ...
                    single_blink_cnt   = 6;
                    single_blink_index = KEY_LCTRL_LED_INDEX;
