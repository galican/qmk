...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_ansi( /* FN */
		...
		_______, BT_HOST1,BT_HOST2,BT_HOST3,BT_2_4G, _______, _______, _______, _______, _______, _______, _______, _______, RM_NEXT,       _______,
		...
		_______, GU_TOGG, _______,                   BT_VOL,                             _______, _______, _______,      RM_SPDD, RM_VALD,  RM_SPDU),
    ...
    [MAC_FN] = LAYOUT_ansi( /* FN */
		...
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                RM_HUEU,
		_______, _______, _______, KC_CALC, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,                RM_VALU, RM_HUED,
		_______, _______, _______,                   BT_VOL,                             _______, _______, _______,       RM_SPDD, RM_VALD, RM_SPDU)
};
